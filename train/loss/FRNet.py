...
if __name__ == '__main__':
    backbone = resnet50(num_classes=8631, include_top=False)
    load_state_dict(backbone, 'emoca-release-EMOCA_v2/assets/FaceRecognition/resnet50_ft_weight.pkl')
    last_feature_size = 2048
    # linear = Linear(last_feature_size, 10) # 2048 is the output of  the resnet50 backbone without the MLP "top"
